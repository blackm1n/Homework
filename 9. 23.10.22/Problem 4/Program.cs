...
//Я был не доволен, что вывод выглядит как равнобедренный треугольник, но все-равно съезжает, если числа слишком большие.
//Поэтому на каждую цифру я вывел одинаковое место, согласно самой большой цифре в треугольнике.
//Сама имплементация конечно оставляет желать лучшего...
